    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="imgUploaderModalLabel"><?php echo app('translator')->get('site.upload-image'); ?></h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="image"><?php echo app('translator')->get('site.uploader-text'); ?></label>
...
"use strict";
    ...
    function getError(jqXHR,textStatus,errorThrown){
        $('#loaderImg').hide();
        $('#uploadMsg').text('<?php echo app('translator')->get('site.upload-error'); ?>');
    }



</script>
<?php /**PATH /home/re3aytk/public_html/dev/resources/views/admin/partials/image-browser.blade.php ENDPATH**/ ?>