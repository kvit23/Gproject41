<div class="accordion" id="accordionExample">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group  <?php echo e($errors->has('picture') ? 'has-error' : ''); ?>">
                            <label for="picture" class="control-label"><?php if($formMode=='edit'): ?><?php echo app('translator')->get('site.change'); ?>    <?php endif; ?> <?php echo app('translator')->get('site.picture'); ?></label>
                        ...
                        <?php if($formMode==='edit' && !empty($candidate->candidate->picture)): ?>
                            ...
                            <a  onclick="return confirm('<?php echo app('translator')->get('site.delete-prompt'); ?>')" class="btn btn-danger int_tpmb" href="<?php echo e(route('admin.candidate.remove-picture',['id'=>$candidate->id])); ?>"><i class="fa fa-trash"></i> <?php echo app('translator')->get('site.delete'); ?> <?php echo app('translator')->get('site.picture'); ?></a>
                    ...
                    <div class="form-group col-md-6 <?php echo e($errors->has('video_code') ? 'has-error' : ''); ?>">
                        <label for="video_code" class="control-label"><?php echo app('translator')->get('site.video-embed-code'); ?></label>
                        <textarea id="video_code" name="video_code" class="form-control"><?php echo e(old('video_code',isset($candidate->candidate->video_code) ? $candidate->candidate->video_code : '')); ?></textarea>
                        <?php echo clean( $errors->first('video_code', '<p class="help-block">:message</p>') ); ?>

                    </div>
                    <?php else: ?>
                        <div class="form-group col-md-6 <?php echo e($errors->has('video_url') ? 'has-error' : ''); ?>">
                            <label for="video_url" class="control-label"><?php echo app('translator')->get('site.video-url'); ?></label>
                             <input placeholder="e.g. https://www.youtube.com/watch?v=8MLXN45zLoM" class="form-control" type="text" name="video_url" value="<?php echo e(old('video_url')); ?>" />

                            <?php echo clean( $errors->first('video_url', '<p class="help-block">:message</p>') ); ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <?php if(!empty($value)): ?>
                                ...
                                <?php if(isImage($value)): ?>
                                    <div><img  data-toggle="modal" data-target="#pictureModalcv" src="<?php echo e(route('admin.image')); ?>?file=<?php echo e($value); ?>"  class="int_w330cur" /></div> <br/>
                                ...
                                <?php endif; ?>
                                <a onclick="return confirm('<?php echo app('translator')->get('site.delete-prompt'); ?>')" class="btn btn-danger" href="<?php echo e(route('admin.candidate.remove-cv',['id'=>$candidate->id])); ?>"><i class="fa fa-trash"></i> <?php echo app('translator')->get('site.delete-file'); ?></a>
                ...
                <div class="form-group col-md-6 <?php echo e($errors->has('employed') ? 'has-error' : ''); ?>">
                    ...
                    <select name="employed" class="form-control" id="employed" >
                        <?php $__currentLoopData = json_decode('{"0":"'.__('site.no').'","1":"'.__('site.yes').'"}', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($optionKey); ?>" <?php echo e(((null !== old('employed',@$candidate->candidate->employed)) && old('employed',@$candidate->candidate->employed) == $optionKey) ? 'selected' : ''); ?>><?php echo e($optionValue); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group col-md-6 <?php echo e($errors->has('shortlisted') ? 'has-error' : ''); ?>">
                    ...
                    <select name="shortlisted" class="form-control" id="shortlisted" >
                        <?php $__currentLoopData = json_decode('{"0":"'.__('site.no').'","1":"'.__('site.yes').'"}', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($optionKey); ?>" <?php echo e(((null !== old('shortlisted',@$candidate->candidate->shortlisted)) && old('shortlisted',@$candidate->candidate->shortlisted) == $optionKey) ? 'selected' : ''); ?>><?php echo e($optionValue); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group col-md-6 <?php echo e($errors->has('locked') ? 'has-error' : ''); ?>">
                    ...
                    <select name="locked" class="form-control" id="locked" >
                        <?php $__currentLoopData = json_decode('{"0":"'.__('site.no').'","1":"'.__('site.yes').'"}', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($optionKey); ?>" <?php echo e(((null !== old('locked',@$candidate->candidate->locked)) && old('locked',@$candidate->candidate->locked) == $optionKey) ? 'selected' : ''); ?>><?php echo e($optionValue); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group col-md-6 <?php echo e($errors->has('status') ? 'has-error' : ''); ?>">
                    ...
                    <select name="status" class="form-control" id="status" >
                        <?php $__currentLoopData = json_decode('{"1":"'.__('site.yes').'","0":"'.__('site.no').'"}', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($optionKey); ?>" <?php echo e(((null !== old('status',@$candidate->candidate->status)) && old('status',@$candidate->candidate->status) == $optionKey) ? 'selected' : ''); ?>><?php echo e($optionValue); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group col-md-6 <?php echo e($errors->has('public') ? 'has-error' : ''); ?>">
                    ...
                    <select name="public" class="form-control" id="public" >
                        <?php $__currentLoopData = json_decode('{"0":"'.__('site.no').'","1":"'.__('site.yes').'"}', true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionKey => $optionValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($optionKey); ?>" <?php echo e(((null !== old('public',@$candidate->candidate->public)) && old('public',@$candidate->candidate->public) == $optionKey) ? 'selected' : ''); ?>><?php echo e($optionValue); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group col-md-6 <?php echo e($errors->has('password') ? 'has-error' : ''); ?>">
                    ...
                    <input class="form-control" name="password" type="password" id="password" value="<?php echo e(old('password',isset($candidate->candidate->password) ? $candidate->candidate->password : '')); ?>" >
    ...
    <?php $__currentLoopData = \App\CandidateFieldGroup::orderBy('sort_order')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card">
                            ...
                            <div class="col-md-12 row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <?php if(!empty($value)): ?>
                                        ...
                                        <?php endif; ?>
                                        <a onclick="return confirm('<?php echo app('translator')->get('site.delete-prompt'); ?>')" class="btn btn-danger" href="<?php echo e(route('admin.candidate.remove-file',['fieldId'=>$field->id,'userId'=>$candidate->id])); ?>"><i class="fa fa-trash"></i> <?php echo app('translator')->get('site.delete-file'); ?></a>
                                        <a class="btn btn-success" href="<?php echo e(route('admin.download')); ?>?file=<?php echo e($value); ?>"><i class="fa fa-download"></i> <?php echo app('translator')->get('site.download'); ?></a>
                                    <?php endif; ?>
                                </div>
...
<?php /**PATH /home/re3aytk/public_html/dev/resources/views/admin/candidates/form.blade.php ENDPATH**/ ?>