...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title',__('site.employer-dashboard')); ?></title>
...
<div class="az-sidebar">
    ...
    <div class="az-sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('employer.dashboard')); ?>" class="nav-link"><i class="fa fa-tachometer-alt"></i>&nbsp; <?php echo app('translator')->get('site.dashboard'); ?></a>
            </li><!-- nav-item -->
            <li class="nav-item">
                <a href="#" class="nav-link with-sub"><i class="fa fa-users"></i>&nbsp; <?php echo app('translator')->get('site.orders'); ?></a>
                <ul class="nav-sub">
                    <li class="nav-sub-item"><a href="<?php echo e(route('profiles')); ?>" class="nav-sub-link"><?php echo app('translator')->get('site.browse-profiles'); ?></a></li>
                    <li class="nav-sub-item"><a href="<?php echo e(route('order-forms')); ?>" class="nav-sub-link"><?php echo app('translator')->get('site.create-order'); ?></a></li>
                    <li class="nav-sub-item"><a href="<?php echo e(route('employer.orders')); ?>" class="nav-sub-link"><?php echo app('translator')->get('site.my-orders'); ?></a></li>
            ...
            <li class="nav-item">
                <a href="<?php echo e(route('employer.placements')); ?>" class="nav-link"><i class="fa fa-user-tie"></i>&nbsp; <?php echo app('translator')->get('site.placements'); ?></a>
            </li><!-- nav-item -->
            <li class="nav-item">
                <a href="<?php echo e(route('employer.interviews')); ?>" class="nav-link"><i class="fa fa-calendar-alt"></i>&nbsp; <?php echo app('translator')->get('site.interviews'); ?></a>
            </li><!-- nav-item -->
            ...
            <li class="nav-item">
                ...
                <ul class="nav-sub">
                    <li class="nav-sub-item"><a href="<?php echo e(route('employer.profile')); ?>" class="nav-sub-link"><?php echo app('translator')->get('site.account-details'); ?></a></li>
        ...
        <div class="container-fluid">
            ...
            <div class="az-header-right">
                ...
                <div class="az-header-message">
                    <a title="<?php echo app('translator')->get('site.your-shortlist'); ?>" href="<?php echo e(route('shortlist')); ?>"><i class="fa fa-users"></i> <small><?php if(is_array(session()->get('cart'))): ?> <?php echo e(count(session()->get('cart'))); ?> <?php endif; ?></small></a>
                </div>
                <?php endif; ?>
    ...
    <div class="az-content-header d-block d-md-flex">
        ...
        <div class="az-dashboard-header-right">
                ...
                <ol class="breadcrumb breadcrumb-style1 mg-b-0">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('employer.dashboard')); ?>"><i class="fas fa-home"></i></a></li>
...
<script src="<?php echo e(asset('js/employer.js')); ?>"></script>
...
<?php /**PATH /home/re3aytk/public_html/dev/resources/views/layouts/employer.blade.php ENDPATH**/ ?>