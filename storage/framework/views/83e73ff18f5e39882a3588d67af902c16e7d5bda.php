<div class="card">
    ...
    <div id="collapse<?php echo e($menu->id); ?>" class="collapse" aria-labelledby="heading<?php echo e($menu->id); ?>">
        <div class="card-body">
            ...
            <form method="post" class="menuform" action="<?php echo e(route('admin.menus.update-footer',['footerMenu'=>$menu->id])); ?>">
                <?php echo csrf_field(); ?>
                ...
                <a onclick="return confirm('<?php echo app('translator')->get('site.confirm-delete'); ?>')" class="btn btn-danger deletemenu" href="<?php echo e(route('admin.menus.delete-footer',['footerMenu'=>$menu->id])); ?>"><?php echo app('translator')->get('site.delete'); ?></a>
                <button class="btn btn-primary float-right"><?php echo app('translator')->get('site.save-changes'); ?></button>

            </form>
        </div>
    </div>
</div><?php /**PATH /home/re3aytk/public_html/dev/resources/views/admin/partials/footer_menu.blade.php ENDPATH**/ ?>