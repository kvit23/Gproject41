...
<?php $__env->startSection('pageTitle',__('site.edit').' '.__('site.role').': '.$role->name); ?>
<?php $__env->startSection('page-title',__('site.edit').' '.__('site.role').': '.$role->name); ?>
...
<?php echo $__env->make('layouts.admin-page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/re3aytk/public_html/dev/resources/views/admin/roles/edit.blade.php ENDPATH**/ ?>